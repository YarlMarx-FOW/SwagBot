...
#————————————————————————————————————————————————————— ТЕКСТОВЫЕ ПАСХАЛКИ/ТРИГГЕРЫ ———————————————————————————————————————————————————————————————————————————————————
    ...
    ("ирисе", "iris", "ирис"): (["Хуйня ебаная.", "Кто-то этим пользуется?", "Ну да, донат за функции, отличный бот.", "ГО. ВНИ. ЩЕ.", "Бот для ЕРП, фу."], "text", "STRICT"),
    ("свага!", "swag!", "свага брат"): (["СВага на месте.", "Свага нашим.", "Свага.", "СВАААААГААААААААААА"], "text", "STRICT", "CHANCE:0.5"),


    # ПРОСТЕЙШИЕ КОНСТРУКЦИИ СПИСОК: СПИСОК
    ("свагстика", "свагстон"): (["Ты что ебанат?", "Какого хуя?", "Это нихуя не свага."], "text", "IS_REPLY"),
    ("свагодвигатель", "свагадвигатель"): (["Младший сын.", "Монстр вайбкодинга.", "Ужасный человек.", "Отвратительная личность.", "Жека Фауст."], "text", "IS_REPLY", "CHANCE:0.5"),
    ("свагогенератор", "свагагенератор"): (["Старший сын.", "Он нашёл девушку?...", "Гей.", "Создатель хайпа.", "Главная мразь общаги, острова, вселенной."], "text", "IS_REPLY", "CHANCE:0.5"),
    ...
    ("где жека", "где свагодвигатель", "куда делся жека", "куда пропал жека"): (["На заводе.", "Хз.", "Потерялся.", "В Свагоатлантиде.", "Ушёл искать своё счастье.", "В отпуске."], "text", "IS_REPLY"),

    # ФОРМАТ СТРОКА: СПИСОК
    "я предал": (["Зачем?", "Главное, что не нас.", "На это высылают Ликвидаторов?", "Как ты мог..."], "text", "STRICT", "IS_REPLY", "CHANCE: 0.7"),
    ...
    "я действ": ("Не действуй, думай.", "text", "IS_REPLY", "CHANCE:0.3"),
...
#————————————————————————————————————————————————————— ОТВЕТЫ ГИФКАМИ ————————————————————————————————————————————————————————————————————————————————————————————————
    #################### ФОРМАТ СПИСОК: СПИСОК
    ("я сделаю", "я удалю", "я забаню", "я успею", "я клянусь"): (["CgACAgQAAxkBAAIH92n-Enyzrt3odHgOp9lJuMKVfVG6AALPAgACqGoNU92xXEi9jrrjOwQ", "CgACAgQAAxkBAAIH9Gn-EnwIASPBieYMKf24j1Tc7RO7AAIsAwACJc0tU-EqAAFk8SQf2DsE",
    ...
    "жека свагодвигатель": ("CgACAgIAAxkBAAIHomn-BxjlIEnRxE-HAw_8B4hT8vHlAALJpQACKeqxSh4L28MuI9OdOwQ", "gif"),
...
#————————————————————————————————————————————————————— ОТВЕТЫ ВИДОСАМИ ———————————————————————————————————————————————————————————————————————————————————————————————
    ...
    ("сказка", "история", "рассказ"): ("BAACAgIAAyEFAASL7DXfAAJ6Q2n9_UdIC_MgVs_1kWoaXnrF2t83AAI-mwACkHLwS8KzyF6IC6iiOwQ", "video", "CHANCE:0.2"),
...
#————————————————————————————————————————————————————— ОТВЕТЫ ПИКЧАМИ ————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    ("что произошло", "в марте", "что случилось", "что тут произошло", "что тут случилось"): ("AgACAgIAAxkBAAIH12n-DizXvo8kfj45MJQCRsrz1ML7AAKfF2sb9QSwS51t5sLIZmI3AQADAgADeQADOwQ", "pic", "IS_REPLY"),
    ("кумарлор", "кумар 73"): ("AgACAgIAAxkBAAIFOWmoSkHf5EHSPj2ZZmgMjSX3yY9TAAICD2sbJ67QS-FPhg1MILfCAQADAgADeQADOgQ", "pic", "IS_REPLY"),
    ("шараг", "хулиган"): ("AgACAgEAAxkBAAIHzWn-DizRI42F8pBjfN8Vi4YdhX_lAALtC2sbbHCZR28-zTazwjKPAQADAgADeAADOwQ", "pic", "IS_REPLY"),
    ("закончились мемы", "нюдсы", "где мемы"): ("AgACAgIAAxkBAAIH2mn-Dixm4fCRPhEB77NU1oDTAnzDAAIoE2sbLFfgS_unnofj4ZDrAQADAgADeAADOwQ", "pic"),
    ...
    ("закон", "цыган"): ("AgACAgIAAyEFAATkLtlfAAJsuWmoK_Y1gTzHlQ5TB78PrhXjmTS9AAIxGGsbAAGBQEnUzMX92AABIxYBAAMCAANtAAM6BA","pic", "TTL:3"),
   ...
   #################### ФОРМАТ СТРОКА: СТРОКА
    "отмен": ("AgACAgIAAxkBAAIHnmn-BxgoNTGE5gj8rfR6I3YAAaFjPAACYxZrG84JoEpWXFY8OTZvlAEAAwIAA3gAAzsE", "pic", "IS_REPLY", "CHANCE:0.7"),
    ...
    "мяу": ("AgACAgIAAxkBAAIHxWn-Dix-psJwGL_Q-WS8SDnCW7LyAAJvFmsbZoyxSjrbRiL254RaAQADAgADeAADOwQ", "pic", "CHANCE:0.4"),
    "патрик": ("AgACAgIAAxkBAAIH02n-Diw5qGfQNHkeSU6XMeExOLtjAAKqE2sbgn-xS3SPiqxWSFTKAQADAgADeAADOwQ", "pic", "CHANCE:0.4"),
    "износ": ("AgACAgIAAxkBAAIH0Gn-DiyG2LJxYcss4_bDdxOTsqQGAAJSFmsbgn-pS2P1vzmlhqoyAQADAgADeQADOwQ", "pic", "CHANCE:0.3"),
    ...
    "наследник": ("AgACAgIAAxkBAAIHnWn-BxiHG3FWzEcRvcUm4NtYHZJ5AAJyFWsbzgmgSuxPrqK9yYkYAQADAgADeQADOwQ", "pic", "CHANCE:0.1"),
    "вайб": ("AgACAgIAAxkBAAIHoGn-Bxg8EV_dVCjzfzaU56UX57qFAAJiFmsbzgmgSjxHu4QFuZY4AQADAgADeAADOwQ", "pic"),
    ...
    "инсульт": ("AgACAgIAAxkBAAIHxGn-DiyZJvzPJmWEGTM8hC06ccsFAAK_F2sbzZ2oSu1g1sEaBw1vAQADAgADbQADOwQ", "pic"),
    "канибализм": ("AgACAgIAAxkBAAIHzmn-Diz7oWsxuVFGskC3sRd-8dkGAAJeGmsbr8QxSzaqmjBd9CTNAQADAgADeAADOwQ", "pic"),
    "король сваг": ("AgACAgIAAx0Cct4JbwABDOvzaaf3r0SL-QXO_2YdTZfXx8f4SYsAAiYTaxv1AUBJvaIDV6yrw4sBAAMCAAN4AAM6BA", "pic"),
    "отличного сваг": ("AgACAgIAAxkBAAIH0mn-DiwE1GxbNVBOGmWSLebbqntzAAKFE2sbgn-xSwYFf82hY15HAQADAgADeAADOwQ", "pic"),
    "до связи": ("AgACAgIAAxkBAAIHw2n-Diw-iOXH5BT7XuCcBX1FZGZ3AALdE2sbkkiZSkkNphuzPrkAAQEAAwIAA3gAAzsE", "pic"),
